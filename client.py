        ...
        try:
            ...
            while True:
                try:
                    ...
                    magic_cookie, msg_type, total_segments, segment_num = struct.unpack('!IbQQ', header)
        ...
        while True:
            try:
                if self.state == ClientState.STARTUP:
                    ...
                    logging.info("Client started, listening for offer requests...")
                    ...
                    logging.info("All transfers complete, listening for offer requests")
                    self.state = ClientState.LOOKING_FOR_SERVER
